...
<table width=100%> 
	...
	<c:if test="${not empty banana}">
		...
		<tr height="30">
			...
			<td align="center">
				<span class="textlink" onmouseover="jsBDetail3(event, ${board.seq})" onmouseout="jsBDetail4()" >${board.seq}</span>
			</td>
			<td>
				...
				<!-- Test 1. 타이틀 클릭하면, 하단(resultArea2)에 글 내용 출력하기  
					...
					** 1) <a href="#resultArea2" onclick="jsBDetail1(${board.seq})">${board.title}</a>
				-->
